...
public class ExpoAdapter extends  RecyclerView.Adapter<ExpoAdapter.HomeDataHolder> {
    ...
    public ExpoAdapter(List<Output> wikiList, Context context) {
    ...
    public HomeDataHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.row_expolayout,viewGroup,false);
